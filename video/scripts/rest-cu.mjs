...
const ctx=await b.newContext({viewport:{width:1100,height:850},deviceScaleFactor:2});
...
await zoom(3.6); await tp(53,31); await p.waitForTimeout(900);
await p.screenshot({path:"/tmp/conn-shots/zz-rest-closeup.png"}); console.log("shot");
await b.close();
